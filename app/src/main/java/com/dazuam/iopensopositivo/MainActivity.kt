package com.dazuam.iopensopositivo
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(  this, "Io Penso Positivo", Toast.LENGTH_LONG).show()
        Log.i("com.dazuam.iopensopositivo", "IoPP Loading")
        //texto.hint
    }

    fun getRandomMessage(): Int{
        posicion = Random.nextInt(from= 0, until= database.size - 1)
        return posicion
    }
    ...
    fun next(view: View){
        texto.text = database[getRandomMessage()]
    }
    ...
    val database = arrayOf("Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
        ...
        "Prefiero morir perndo lo que quiero, que vivir haciendo lo que me quita la vida.-Autor desconocido.",
